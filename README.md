...
Come già detto in precedenza per le statistiche del fantacalcio siamo andati su [Fantasy Football Statistics](https://www.fantacalcio.it/statistiche-serie-a) e abbiamo scaricato un file su github con una tabella che facesse vedere tutti i calciatori con  nome,squadra di appartenenza del calciatore in questione, partite giocate, mediavoto e mediafantavoto, rigori parati(se portiere) rigori calciati e sbagliati(se giocatore di movimento), assist, ammonizioni, espulsioni e autogoal. Il file in questione è visionabile in formato pdf [qui](https://github.com/Daniel-Diocis/Progetto-assistente-fantacalcio/blob/main/Statistiche-Fantacalcio-2021:2022.pdf) e inoltre lo abbiamo anche scaricato in un altro formato cosicchè da ques'ultimo, situato [qui](https://github.com/Daniel-Diocis/Progetto-assistente-fantacalcio/blob/main/Statistiche_Fantacalcio_2021-22-2.xlsx), abbiamo potuto creare un file json da utilizzare  su eclipse per la composizione del programma.
